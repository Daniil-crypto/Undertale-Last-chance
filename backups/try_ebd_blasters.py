    ...
    def draw(self, sec=20, sec1=0, sec_end=30):
        ...
        if self.type == "blaster":
            ...
            if self.sec >= sec + sec1 + sec_end:
                self.stop()
                return
            screen.blit(self.track1, (self.x - 2000 + self.pos()[0], self.y - 1800 + self.pos()[1]))
...
if __name__ == '__main__':
    ...
    g = 0.2
    at.blasters.append(Atk("white", "blaster", 100, 200, 42, 57, False, 95))
    at.blasters.append(Atk("white", "blaster", 400, 200, 42, 57, False, -45))
    at.blasters.append(Atk("white", "blaster", 100, 360, 42, 57, False, 45))
    at.blasters.append(Atk("white", "blaster", 400, 360, 42, 57, False, -45))
    pygame.display.flip()
